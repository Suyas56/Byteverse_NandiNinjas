...
//     // Immediately update UI with the user message and a placeholder for AI response.
//     setChats((prevChats) => [
//       ...prevChats,
//       userChat,
//       {
...
//         'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyAc1J6qpTty23_uKELvphHAnX-NIHrj_lg',
//         { message: userMessage }
//       );
//       const aiMessage = response.data.reply || 'I am sorry, I cannot process that right now.';
